...
func writeResults(rows []resultRow) {
	...
	payload := struct {
		...
		"petStats":              "forever-provisional-shared-hunter-warlock-owner-scaling-explicit-pet-talents-no-generic-pet-buffs-or-consumes",
		"lifeTap":               "client-level-capped-base-plus-spirit-improved-health-and-mana-tier-mana-only",
		"hunterTalentMasks":     "client-scoped-efficiency-resourcefulness-predators-edge-focused-fire-both-owner-pet",
		"moonfury":              "arcane-nature-total-damage-school-multiplier",
		"priestResourceTalents": "improved-healing-penance-separate-inner-focus-cost-and-crit-masks",
		"trueshot":              "stronger-legal-rank-20905-75-ranged-ap",
